...
- **Traducciones · Proyectos** y **Traducciones · Game jams**: editar únicamente la versión inglesa. Para una ficha nueva, crea aquí su traducción, selecciona el proyecto y completa los textos ingleses. Las traducciones se guardan aparte y la web las combina automáticamente con la ficha española.
...
- **Desarrollo y aprendizajes**: campo opcional con editor de texto enriquecido para explicar qué aprendiste y qué herramientas, técnicas o patrones utilizaste. Admite párrafos, listas con viñetas o numeradas, negrita, cursiva y enlaces. Si lo rellenas, completa sus versiones española e inglesa.
...
- **URL del vídeo corto de portada**: sube a Cloudinary un MP4 de 720p, 16:9, sin audio y optimizado, copia su URL segura y pégala en este campo. Se reproduce automáticamente en las tarjetas destacadas.
