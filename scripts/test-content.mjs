...
assert.equal(prepareContent([{ ...game, previewVideo: "/videos/preview.mp4" }], [], {}).games[0].previewVideo, "/videos/preview.mp4");
assert.throws(() => prepareContent([{ ...game, previewVideo: "/videos/preview.webm" }], [], {}), /previewVideo/);
assert.throws(() => prepareContent([{ ...game, previewVideo: "https://www.youtube.com/watch?v=test" }], [], {}), /previewVideo/);
